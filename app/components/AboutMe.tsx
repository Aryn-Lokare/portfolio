      ...
      <div className="flex flex-col items-center gap-6 sm:gap-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 sm:gap-6 w-full max-w-[1100px] mt-4 sm:mt-6">
          ...
          <div 
            ...
            className="flex flex-col justify-between bg-[#121316] rounded-[20px] sm:rounded-[28px] overflow-hidden border border-zinc-800/80 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1 group md:col-span-5 cursor-pointer"
          >
            <div className="relative w-full aspect-[4/3] overflow-hidden bg-zinc-950">
              <Image
                ...
                className={`object-cover transition-transform duration-500 ${
                  activeCard === 1 ? 'scale-105' : 'group-hover:scale-105'
                }`}
                sizes="(max-width: 768px) 100vw, 500px"
                priority
              />
              {/* Hover/Tap Text Overlay */}
              <div className={`absolute inset-0 bg-[#121316]/80 backdrop-blur-[6px] flex flex-col justify-end p-4 sm:p-6 transition-all duration-300 ${
                activeCard === 1 ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
              }`}>
                <div className={`transform transition-transform duration-300 flex flex-col gap-1 ${
          ...
          <div 
            ...
            className="flex flex-col justify-between bg-[#121316] rounded-[20px] sm:rounded-[28px] overflow-hidden border border-zinc-800/80 shadow-sm transition-all duration-300 hover:shadow-md hover:-translate-y-1 group md:col-span-7 cursor-pointer"
          >
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:flex-grow overflow-hidden bg-zinc-950 min-h-[180px] sm:min-h-[220px]">
              <Image
                ...
                fill
                className={`object-cover transition-transform duration-500 ${
                  activeCard === 2 ? 'scale-105' : 'group-hover:scale-105'
                }`}
              ...
              <div className={`absolute inset-0 bg-[#121316]/80 backdrop-blur-[6px] flex flex-col justify-end p-4 sm:p-6 transition-all duration-300 ${
                ...
                <div className={`transform transition-transform duration-300 flex flex-col gap-1 ${
                  activeCard === 2 ? 'translate-y-0' : 'translate-y-4 group-hover:translate-y-0'
                }`}>
                  <h3 className="font-sans font-semibold text-[18px] sm:text-[20px] text-white tracking-[-0.5px]">
                    Builders Mindset 
                  </h3>
          ...
          >
            <div className="relative w-full aspect-[16/10] md:aspect-auto md:flex-grow overflow-hidden bg-zinc-950 min-h-[180px] sm:min-h-[220px]">
              <Image
                ...
                fill
                className={`object-cover transition-transform duration-500 ${
                  activeCard === 3 ? 'scale-105' : 'group-hover:scale-105'
                }`}
                sizes="(max-width: 768px) 100vw, 700px"
              />
              {/* Hover/Tap Text Overlay */}
              <div className={`absolute inset-0 bg-[#121316]/80 backdrop-blur-[6px] flex flex-col justify-end p-4 sm:p-6 transition-all duration-300 ${
                ...
                <div className={`transform transition-transform duration-300 flex flex-col gap-1 ${
                  activeCard === 3 ? 'translate-y-0' : 'translate-y-4 group-hover:translate-y-0'
                }`}>
                  <h3 className="font-sans font-semibold text-[18px] sm:text-[20px] text-white tracking-[-0.5px]">
          ...
          >
            <div className="relative w-full aspect-[4/3] overflow-hidden bg-zinc-950">
              <Image
                ...
                fill
                className={`object-cover transition-transform duration-500 ${
                  activeCard === 4 ? 'scale-105' : 'group-hover:scale-105'
                }`}
                sizes="(max-width: 768px) 100vw, 500px"
              />
              {/* Hover/Tap Text Overlay */}
              <div className={`absolute inset-0 bg-[#121316]/80 backdrop-blur-[6px] flex flex-col justify-end p-4 sm:p-6 transition-all duration-300 ${
                activeCard === 4 ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'
              }`}>
                <div className={`transform transition-transform duration-300 flex flex-col gap-1 ${
                  activeCard === 4 ? 'translate-y-0' : 'translate-y-4 group-hover:translate-y-0'
                }`}>
                  <h3 className="font-sans font-semibold text-[18px] sm:text-[20px] text-white tracking-[-0.5px]">
                    Team Leadership
                  </h3>
